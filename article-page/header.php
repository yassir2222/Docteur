...
<nav class="s-header__nav-wrap">
    ...
    <ul class="s-header__nav">
        ...
        <li class="has-children">
            ...
            <ul class="sub-menu">
                <li><a href="./single-pages/épaule/pathologie-de-la-coiffe.html">Pathologies de la coiffe des rotateurs</a></li>
                <li><a href="category.html">L’instabilité de l’épaule</a></li>
